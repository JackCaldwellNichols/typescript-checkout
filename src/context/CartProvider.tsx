...
const INIT_CART_STATE: CartStateType = {cart: []}   
...
const reducer = (state: CartStateType, action: ReducerAction): 
    ...
    const useCartContext = (INIT_CART_STATE: CartStateType) => {
        const [state, dispatch] = useReducer(reducer, INIT_CART_STATE)
...
export const CartProvider = ({children}: ChildrenType): ReactElement => {
    return (
        <CartContext.Provider value={useCartContext(INIT_CART_STATE)}>{children}</CartContext.Provider>
    )
}
